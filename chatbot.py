...
client = replicate.Client(api_token="Add the client token here")
...
# Function to run video model and get output
# def run_video_model(video_data, text_prompt):
#     input_data = {
...
#        encoded_video = encode_video_to_base64(file_content)
#       summary = run_video_model(encoded_video, "Generate a summary for this video")
    else:
