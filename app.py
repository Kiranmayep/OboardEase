...
def main():
            ...
            for role, message in st.session_state.history:
                if role == "User":
                    ...
                    <div style="display: flex; align-items: center; margin-bottom: 10px;">
                        <img src="https://img.icons8.com/?size=100&id=23265&format=png&color=FFFFFF" style="width: 25px; margin-right: 10px;">
                        <strong>User:</strong>
                    </div>
                    <div>{message}</div>
                    ...
                    st.markdown(f"""
                    <div style="display: flex; align-items: center; margin-bottom: 10px;">
                        <img src="https://img.icons8.com/?size=100&id=22853&format=png&color=FFFFFF" style="width: 25px; margin-right: 10px;">
    ...
    if ask_button:
        if st.session_state.query:
            user_query = st.session_state.query  # Save the query before clearing the input
